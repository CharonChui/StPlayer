...
import com.st.preload.disk.UnlimitedDiskUsage;
import com.st.preload.exception.ProxyCacheException;
import com.st.preload.utils.Files;
...
/**
 * {@link ICache} that uses file for storing data.
 *
...
public class FileCache implements ICache {
    ...
    private final IDiskUsage diskUsage;
    public File file;
    ...
    public FileCache(File file, IDiskUsage diskUsage) throws ProxyCacheException {
        try {
            if (diskUsage == null) {
