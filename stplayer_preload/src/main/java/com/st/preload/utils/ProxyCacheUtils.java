...
public class ProxyCacheUtils {
    public static final String LOG_TAG = ProxyCacheUtils.class.getName();
    ...
    public static void assertBuffer(@NonNull byte[] buffer, long offset, int length) {
