...
import com.st.preload.headers.EmptyHeadersInjectorI;
...
/**
 * {@link ISource} that uses http resource as source for {@link com.st.preload.server.ProxyCache}.
 *
 * @author Alexey Danilov (danikula@gmail.com).
 */
public class HttpUrlSource implements ISource {
    private static final String LOG_TAG = HttpUrlSource.class.getName();

    private static final int MAX_REDIRECTS = 5;
    private final SourceInfoStorage sourceInfoStorage;
    private final IHeaderInjector headerInjector;
    ...
    public HttpUrlSource(String url, SourceInfoStorage sourceInfoStorage) {
        this(url, sourceInfoStorage, new EmptyHeadersInjectorI());
    }

    public HttpUrlSource(String url, SourceInfoStorage sourceInfoStorage, IHeaderInjector headerInjector) {
        ...
        this.sourceInfo = sourceInfo != null ? sourceInfo :
                new SourceInfo(url, Integer.MIN_VALUE,
    ...
    public void close() throws ProxyCacheException {
        if (connection != null) {
            try {
                ...
                Log.e(LOG_TAG, "Error closing connection correctly. Should happen only on Android L. " +
    ...
    private void fetchContentInfo() throws ProxyCacheException {
        ...
        try {
            ...
            Log.d(LOG_TAG, "Error fetching info from " + sourceInfo.url, e);
        } finally {
