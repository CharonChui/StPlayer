...
class GLSurfaceRender(private val mContext: Context, private val mGLSurfaceView: GLSurfaceView) :
    AbsGLSurfaceViewRenderer() {
    ...
    override fun onSurfaceCreated(
        ...
        mSurfaceTexture?.let {
            mSurfaceTexture!!.setDefaultBufferSize(mGLSurfaceView.width, mGLSurfaceView.height)
