...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public void setSurfaceTextureListener(SurfaceTextureListener listener) {
        ...
        LogUtil.Companion.e(TAG, "setSurfaceTextureListener preserved, setRenderer() instead?");
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (LOG_ATTACH_DETACH) {
            LogUtil.Companion.d(TAG, "onAttachedToWindow reattach =" + mDetached);
        }
    ...
    protected void onDetachedFromWindow() {
        if (LOG_ATTACH_DETACH) {
            LogUtil.Companion.d(TAG, "onDetachedFromWindow");
        }
        if (mGLThread != null) {
            mGLThread.requestExitAndWait();
        }
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        public void destroyContext(EGL10 egl, EGLDisplay display,
            ...
            if (!egl.eglDestroyContext(display, context)) {
                LogUtil.Companion.e("DefaultContextFactory", "display:" + display + " context: " + context);
                if (LOG_THREADS) {
                    LogUtil.Companion.i("DefaultContextFactory", "tid=" + Thread.currentThread().getId());
                }
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        public EGLSurface createWindowSurface(EGL10 egl, EGLDisplay display,
            ...
            try {
                ...
                LogUtil.Companion.e(TAG, "eglCreateWindowSurface" + e);
            }
            return result;
        }
    ...
    private static class EglHelper {
        ...
        public void start() {
            if (LOG_EGL) {
                LogUtil.Companion.w("EglHelper", "start() tid=" + Thread.currentThread().getId());
            }
            /*
             * Get an EGL instance
             */
            ...
            if (LOG_EGL) {
                LogUtil.Companion.w("EglHelper", "createContext " + mEglContext + " tid=" + Thread.currentThread().getId());
            }
        ...
        public boolean createSurface() {
            if (LOG_EGL) {
                LogUtil.Companion.w("EglHelper", "createSurface()  tid=" + Thread.currentThread().getId());
            }
            /*
             * Check preconditions.
             */
            ...
            if (mEglSurface == null || mEglSurface == EGL10.EGL_NO_SURFACE) {
                ...
                if (error == EGL10.EGL_BAD_NATIVE_WINDOW) {
                    LogUtil.Companion.e("EglHelper", "createWindowSurface returned EGL_BAD_NATIVE_WINDOW.");
                }
                return false;
            }
        ...
        public void destroySurface() {
            if (LOG_EGL) {
                LogUtil.Companion.w("EglHelper", "destroySurface()  tid=" + Thread.currentThread().getId());
            }
            destroySurfaceImp();
        }
        ...
        public void finish() {
            if (LOG_EGL) {
                LogUtil.Companion.w("EglHelper", "finish() tid=" + Thread.currentThread().getId());
            }
            if (mEglContext != null) {
                GLTextureView view = mGLTextureViewWeakRef.get();
                if (view != null) {
        ...
        public static void throwEglException(String function, int error) {
            ...
            if (LOG_THREADS) {
                LogUtil.Companion.e("EglHelper", "throwEglException tid=" + Thread.currentThread().getId() + " "
                        + message);
            }
        ...
        public static void logEglErrorAsWarning(String tag, String function, int error) {
            LogUtil.Companion.w(tag, formatEglError(function, error));
        }
    ...
    static class GLThread extends Thread {
        ...
        public void run() {
            ...
            if (LOG_THREADS) {
                LogUtil.Companion.i("GLThread", "starting tid=" + getId());
            }
        ...
        private void guardedRun() throws InterruptedException {
            ...
            try {
                ...
                while (true) {
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            if (mPaused != mRequestPaused) {
                                ...
                                if (LOG_PAUSE_RESUME) {
                                    LogUtil.Companion.i("GLThread", "mPaused is now " + mPaused + " tid=" + getId());
                                }
                            }
                            ...
                            if (mShouldReleaseEglContext) {
                                if (LOG_SURFACE) {
                                    LogUtil.Companion.i("GLThread", "releasing EGL context because asked to tid=" + getId());
                                }
                            ...
                            if (pausing && mHaveEglSurface) {
                                if (LOG_SURFACE) {
                                    LogUtil.Companion.i("GLThread", "releasing EGL surface because paused tid=" + getId());
                                }
                                stopEglSurfaceLocked();
                            }
                            ...
                            if (pausing && mHaveEglContext) {
                                ...
                                if (!preserveEglContextOnPause || sGLThreadManager.shouldReleaseEGLContextWhenPausing()) {
                                    stopEglContextLocked();
                                    if (LOG_SURFACE) {
                                        LogUtil.Companion.i("GLThread", "releasing EGL context because paused tid=" + getId());
                                    }
                                }
                            }
                            ...
                            if (pausing) {
                                if (sGLThreadManager.shouldTerminateEGLWhenPausing()) {
                                    mEglHelper.finish();
                                    if (LOG_SURFACE) {
                                        LogUtil.Companion.i("GLThread", "terminating EGL because paused tid=" + getId());
                                    }
                                }
                            }
                            ...
                            if ((!mHasSurface) && (!mWaitingForSurface)) {
                                if (LOG_SURFACE) {
                                    LogUtil.Companion.i("GLThread", "noticed TextureView surface lost tid=" + getId());
                                }
                                if (mHaveEglSurface) {
                                    stopEglSurfaceLocked();
                                }
                            ...
                            if (mHasSurface && mWaitingForSurface) {
                                if (LOG_SURFACE) {
                                    LogUtil.Companion.i("GLThread", "noticed TextureView surface acquired tid=" + getId());
                                }
                            ...
                            if (doRenderNotification) {
                                if (LOG_SURFACE) {
                                    LogUtil.Companion.i("GLThread", "sending render notification tid=" + getId());
                                }
                            ...
                            if (LOG_THREADS) {
                                LogUtil.Companion.i("GLThread", "waiting tid=" + getId()
                    ...
                    if (createEglSurface) {
                        if (LOG_SURFACE) {
                            LogUtil.Companion.w("GLThread", "egl createSurface");
                        }
                    ...
                    if (createEglContext) {
                        if (LOG_RENDERER) {
                            LogUtil.Companion.w("GLThread", "onSurfaceCreated");
                        }
                        GLTextureView view = mGLTextureViewWeakRef.get();
                        if (view != null) {
                    ...
                    if (sizeChanged) {
                        if (LOG_RENDERER) {
                            LogUtil.Companion.w("GLThread", "onSurfaceChanged(" + w + ", " + h + ")");
                        }
                        GLTextureView view = mGLTextureViewWeakRef.get();
                        if (view != null) {
                    ...
                    if (LOG_RENDERER_DRAW_FRAME) {
                        LogUtil.Companion.w("GLThread", "onDrawFrame tid=" + getId());
                    }
                    ...
                    if (needSwap) {
                        ...
                        switch (swapError) {
                            ...
                            case EGL11.EGL_CONTEXT_LOST:
                                if (LOG_SURFACE) {
                                    LogUtil.Companion.i("GLThread", "egl context lost tid=" + getId());
                                }
                                lostEglContext = true;
                                break;
                            default:
        ...
        public void surfaceCreated() {
            synchronized (sGLThreadManager) {
                if (LOG_THREADS) {
                    LogUtil.Companion.i("GLThread", "surfaceCreated tid=" + getId());
                }
                mHasSurface = true;
        ...
        public void surfaceDestroyed() {
            synchronized (sGLThreadManager) {
                if (LOG_THREADS) {
                    LogUtil.Companion.i("GLThread", "surfaceDestroyed tid=" + getId());
                }
                mHasSurface = false;
                sGLThreadManager.notifyAll();
        ...
        public void onPause() {
            synchronized (sGLThreadManager) {
                if (LOG_PAUSE_RESUME) {
                    LogUtil.Companion.i("GLThread", "onPause tid=" + getId());
                }
                mRequestPaused = true;
                sGLThreadManager.notifyAll();
                while ((!mExited) && (!mPaused)) {
                    if (LOG_PAUSE_RESUME) {
                        LogUtil.Companion.i("Main thread", "onPause waiting for mPaused.");
                    }
                    try {
                        sGLThreadManager.wait();
        ...
        public void onResume() {
            synchronized (sGLThreadManager) {
                if (LOG_PAUSE_RESUME) {
                    LogUtil.Companion.i("GLThread", "onResume tid=" + getId());
                }
                ...
                while ((!mExited) && mPaused && (!mRenderComplete)) {
                    if (LOG_PAUSE_RESUME) {
                        LogUtil.Companion.i("Main thread", "onResume waiting for !mPaused.");
                    }
                    try {
                        sGLThreadManager.wait();
                    } catch (InterruptedException ex) {
        ...
        public void onWindowResize(int w, int h) {
            synchronized (sGLThreadManager) {
                ...
                while (!mExited && !mPaused && !mRenderComplete
                        && ableToDraw()) {
                    if (LOG_SURFACE) {
                        LogUtil.Companion.i("Main thread", "onWindowResize waiting for render complete from tid=" + getId());
                    }
                    try {
                        sGLThreadManager.wait();
                    } catch (InterruptedException ex) {
    ...
    static class LogWriter extends Writer {
        ...
        private void flushBuilder() {
            if (mBuilder.length() > 0) {
                LogUtil.Companion.v("GLTextureView", mBuilder.toString());
    ...
    private static class GLThreadManager {
        ...
        public synchronized void threadExiting(GLThread thread) {
            if (LOG_THREADS) {
                LogUtil.Companion.i("GLThread", "exiting tid=" + thread.getId());
            }
            thread.mExited = true;
            if (mEglOwner == thread) {
                mEglOwner = null;
        ...
        public synchronized void checkGLDriver(GL10 gl) {
            if (!mGLESDriverCheckComplete) {
                ...
                if (LOG_SURFACE) {
                    LogUtil.Companion.w(TAG, "checkGLDriver renderer = \"" + renderer + "\" multipleContextsAllowed = "
                            + mMultipleGLESContextsAllowed
...
//                }
                if (LOG_SURFACE) {
                    LogUtil.Companion.w(TAG, "checkGLESVersion mGLESVersion =" +
